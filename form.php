...
<form role="form" class="form-horizontal form-group mt-2" method="POST" action="form_bmi.php">
    ...
    <div class="col-8">
      <input id="tgl_periksa" name="tgl_periksa" type="date" class="form-control" required="tolong diisi">
    </div>
  </div> 
  <div class="form-group row">
    <label for="kode" class="col-4 col-form-label">Kode</label> 
    <div class="col-8">
      <input id="kode" name="kode" type="text" class="form-control" placeholder="P004" required="required">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="berat" name="berat" type="number" class="form-control" placeholder="kg" required="required">
    </div>
  </div>
  <div class="form-group row">
    <label for="tinggi" class="col-4 col-form-label">Tinggi</label> 
    <div class="col-8">
      <input id="tinggi" name="tinggi" type="number" class="form-control" placeholder="cm" required="required">
    </div>
  </div>
  <div class="form-group row">
